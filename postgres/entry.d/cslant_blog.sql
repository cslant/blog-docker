...
SELECT pg_catalog.setval('public.activations_id_seq', (SELECT MAX(id) FROM public.activations) + 1);
...
SELECT pg_catalog.setval('public.admin_notifications_id_seq', (SELECT MAX(id) FROM public.admin_notifications) + 1);
...
SELECT pg_catalog.setval('public.audit_histories_id_seq', (SELECT MAX(id) FROM public.audit_histories) + 1);
...
SELECT pg_catalog.setval('public.blocks_id_seq', (SELECT MAX(id) FROM public.blocks) + 1);
...
SELECT pg_catalog.setval('public.categories_id_seq', (SELECT MAX(id) FROM public.categories) + 1);
...
SELECT pg_catalog.setval('public.contact_replies_id_seq', (SELECT MAX(id) FROM public.contact_replies) + 1);
...
SELECT pg_catalog.setval('public.contacts_id_seq', (SELECT MAX(id) FROM public.contacts) + 1);
...
SELECT pg_catalog.setval('public.custom_fields_id_seq', (SELECT MAX(id) FROM public.custom_fields) + 1);
...
SELECT pg_catalog.setval('public.dashboard_widget_settings_id_seq', (SELECT MAX(id) FROM public.dashboard_widget_settings) + 1);
...
SELECT pg_catalog.setval('public.dashboard_widgets_id_seq', (SELECT MAX(id) FROM public.dashboard_widgets) + 1);
...
SELECT pg_catalog.setval('public.failed_jobs_id_seq', (SELECT MAX(id) FROM public.failed_jobs) + 1);
...
SELECT pg_catalog.setval('public.field_groups_id_seq', (SELECT MAX(id) FROM public.field_groups) + 1);
...
SELECT pg_catalog.setval('public.field_items_id_seq', (SELECT MAX(id) FROM public.field_items) + 1);
...
SELECT pg_catalog.setval('public.galleries_id_seq', (SELECT MAX(id) FROM public.galleries) + 1);
...
SELECT pg_catalog.setval('public.gallery_meta_id_seq', (SELECT MAX(id) FROM public.gallery_meta) + 1);
...
SELECT pg_catalog.setval('public.jobs_id_seq', (SELECT MAX(id) FROM public.jobs) + 1);
...
SELECT pg_catalog.setval('public.language_meta_lang_meta_id_seq', (SELECT MAX(id) FROM public.language_meta) + 1);
...
SELECT pg_catalog.setval('public.languages_lang_id_seq', (SELECT MAX(id) FROM public.languages) + 1);
...
SELECT pg_catalog.setval('public.media_files_id_seq', (SELECT MAX(id) FROM public.media_files) + 1);
...
SELECT pg_catalog.setval('public.media_folders_id_seq', (SELECT MAX(id) FROM public.media_folders) + 1);
...
SELECT pg_catalog.setval('public.media_settings_id_seq', (SELECT MAX(id) FROM public.media_settings) + 1);
...
SELECT pg_catalog.setval('public.member_activity_logs_id_seq', (SELECT MAX(id) FROM public.member_activity_logs) + 1);
...
SELECT pg_catalog.setval('public.members_id_seq', (SELECT MAX(id) FROM public.members) + 1);
...
SELECT pg_catalog.setval('public.menu_locations_id_seq', (SELECT MAX(id) FROM public.menu_locations) + 1);
...
SELECT pg_catalog.setval('public.menu_nodes_id_seq', (SELECT MAX(id) FROM public.menu_nodes) + 1);
...
SELECT pg_catalog.setval('public.menus_id_seq', (SELECT MAX(id) FROM public.menus) + 1);
...
SELECT pg_catalog.setval('public.meta_boxes_id_seq', (SELECT MAX(id) FROM public.meta_boxes) + 1);
...
SELECT pg_catalog.setval('public.migrations_id_seq', (SELECT MAX(id) FROM public.migrations) + 1);
...
SELECT pg_catalog.setval('public.pages_id_seq', (SELECT MAX(id) FROM public.pages) + 1);
...
SELECT pg_catalog.setval('public.personal_access_tokens_id_seq', (SELECT MAX(id) FROM public.personal_access_tokens) + 1);
...
SELECT pg_catalog.setval('public.post_categories_id_seq', (SELECT MAX(id) FROM public.post_categories) + 1);
...
SELECT pg_catalog.setval('public.post_tags_id_seq', (SELECT MAX(id) FROM public.post_tags) + 1);
...
SELECT pg_catalog.setval('public.posts_id_seq', (SELECT MAX(id) FROM public.posts) + 1);
...
SELECT pg_catalog.setval('public.request_logs_id_seq', (SELECT MAX(id) FROM public.request_logs) + 1);
...
SELECT pg_catalog.setval('public.revisions_id_seq', (SELECT MAX(id) FROM public.revisions) + 1);
...
SELECT pg_catalog.setval('public.roles_id_seq', (SELECT MAX(id) FROM public.roles) + 1);
...
SELECT pg_catalog.setval('public.settings_id_seq', (SELECT MAX(id) FROM public.settings) + 1);
...
SELECT pg_catalog.setval('public.slugs_id_seq', (SELECT MAX(id) FROM public.slugs) + 1);
...
SELECT pg_catalog.setval('public.tags_id_seq', (SELECT MAX(id) FROM public.tags) + 1);
...
SELECT pg_catalog.setval('public.translations_id_seq', (SELECT MAX(id) FROM public.translations) + 1);
...
SELECT pg_catalog.setval('public.user_meta_id_seq', (SELECT MAX(id) FROM public.user_meta) + 1);
...
SELECT pg_catalog.setval('public.users_id_seq', (SELECT MAX(id) FROM public.users) + 1);
...
SELECT pg_catalog.setval('public.widgets_id_seq', (SELECT MAX(id) FROM public.widgets) + 1);
