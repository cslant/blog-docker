...
usage() {
  ...
  echo '  build_all | ba  Build blog with Docker (All services: nginx, postgres, php, node, fe, elasticsearch and more tools)'
  echo '  network | n     Create Docker network'
  echo '  start | s       Start blog with Docker'
  echo '  start_all | sa  Start blog with Docker (All services: nginx, postgres, php, node, fe, elasticsearch and more tools)'
